...
You should not edit in the master branch, therefore you'll need to explore the existing branches and create one if needed, then switch to that branch prior to editing project.  Finally, you need to push your commits to the branch that you're working on.
